    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NombreArea', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z]')])),
            ],
        ),
        migrations.CreateModel(
            name='Cargo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Password', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z]')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IdArea', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='senttevaluationapp.area')),
            ],
        ),
        migrations.CreateModel(
            name='PerfilRol',
            fields=[
                ...
                ('RelacionEvaluado', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z]')])),
                ('NombreEvaluador', models.CharField(blank=True, default='', max_length=50, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z]')])),
                ('NombreCalibrador', models.CharField(blank=True, default='', max_length=50, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z]')])),
            ],
        ),
        migrations.CreateModel(
            name='PlanAccion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IdCargo', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='senttevaluationapp.cargo')),
            ],
        ),
        migrations.CreateModel(
            name='Evaluacion',
        ...
        migrations.AddField(
            model_name='empleado',
            name='IdRol',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='senttevaluationapp.perfilrol'),
        ),
        migrations.AddField(
            model_name='empleado',
            name='IdSubGerencia',
